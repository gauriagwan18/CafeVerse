...
public class SandwichMenuui {
    
 Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
        double screenWidth = screenBounds.getWidth();
        double screenHeight = screenBounds.getHeight();

    public Scene createSandwichScene(Stage stage) {
        Label title = new Label(" Welcome to Sandwich Station");
        ...
        String[][] items = {
            {"Grilled Veggie Delight", "₹99", "/assets/images/grilledsand.jpeg"},
            {"Paneer Tikka Sandwich", "₹129", "/assets/images/paneertikkasandwich.jpeg"},
            {"Cheese Corn Sandwich", "₹109", "/assets/images/cheesecornsandwich.jpeg"},
            {"Bombay Masala Sandwich", "₹89", "/assets/images/bombaymasalasandwich.jpeg"},
            {"Chilli Cheese Toast", "₹119", "/assets/images/bombaymasalasandwich.jpeg"},
            {"Spinach & Cheese Griller", "₹115", "/assets/images/spinachandcheesegriller.jpeg"},
            {"Triple Veg Club", "₹139", "/assets/images/triplevegclub.jpeg"},
            {"Peri Peri Veg Sandwich", "₹125", "/assets/images/periperisand.jpeg"},
            {"Italian Pesto Veg", "₹135", "/assets/images/itpestoveg.jpeg"},
            {"Mushroom & Cheese", "₹129", "/assets/images/mush.jpeg"}
        };
...
topRightButtons.setPadding(new Insets(10, 30, 0, 0));
    ...
    public void showSandwichMenu(Stage stage) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'showSandwichMenu'");
    }
}
