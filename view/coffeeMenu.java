...
public class coffeeMenu {
    ...
    public Scene createCoffeeScene(Stage stage) {
        
        Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
        double screenWidth = screenBounds.getWidth();
        double screenHeight = screenBounds.getHeight();
        Label title = new Label("☕ Welcome to Coffee Zone ☕");
...
topRightButtons.setPadding(new Insets(10, 30, 0, 0));
    ...
    public void showCoffeeMenu(Stage stage) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'showCoffeeMenu'");
    }
}
