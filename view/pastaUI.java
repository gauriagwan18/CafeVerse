...
public class pastaUI {

    public Scene createPastaScene(Stage stage) {
        
        Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
        double screenWidth = screenBounds.getWidth();
        double screenHeight = screenBounds.getHeight();
        Label title = new Label("🍝 Welcome to the Pasta Paradise!");
        ...
        String[][] items = {
            ...
            {" Classic Alfredo Penne", "₹199", "/assets/images/classicalfredo.jpeg"},
            {"Spicy Arrabbiata Fusilli", "₹179", "/assets/images/spicyarra.jpeg"},
            {"Creamy Mushroom Fettuccine", "₹219", "/assets/images/creamymush.jpeg"},
            {"Cheesy Tomato Macaroni", "₹169", "/assets/images/cheesetom.jpeg"},
            {"Pesto Basil Spaghetti", "₹199", "/assets/images/spaghetti.jpeg"},
            {"Four Cheese Baked Ziti", "₹249", "/assets/images/ziti.jpeg"},
            {"Veggie Delight Lasagna", "₹239", "/assets/images/veglasagna.jpeg"},
            {"Garlic & Olive Oil Linguine", "₹189", "/assets/images/llinguine.jpeg"},
            {"Smoky Chipotle Penne", "209", "/assets/images/chitpotle.jpeg"},
            {"Truffle Cream Tagliatelle", "₹269", "/assets/images/truffle.jpeg"},
...
topRightButtons.setPadding(new Insets(10, 30, 0, 0));
    ...
    public void start(Stage primaryStage) {
       primaryStage.setTitle("Café Mood UI");
        primaryStage.setScene(createPastaScene(primaryStage));
